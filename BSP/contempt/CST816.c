...
volatile uint8_t CST816_DebugChipID;
volatile uint8_t CST816_DebugFingerNum;
volatile uint8_t CST816_DebugXYRaw[4];
volatile uint16_t CST816_DebugX;
volatile uint16_t CST816_DebugY;
...
void CST816_Init(void)
{
	CST816_GPIO_Init();
	CST816_RESET();
	CST816_IIC_WriteREG(DisAutoSleep, 0x01);
	CST816_Config_AutoSleepTime(0xFF);
	CST816_DebugChipID = CST816_Get_ChipID();
}
...
void CST816_Get_XY_AXIS(void)
{
	...
	CST816_DebugXYRaw[0] = DAT[0];
	CST816_DebugXYRaw[1] = DAT[1];
	CST816_DebugXYRaw[2] = DAT[2];
	CST816_DebugXYRaw[3] = DAT[3];
	...
	CST816_DebugX = (uint16_t)CST816_Instance.X_Pos;
	CST816_DebugY = (uint16_t)CST816_Instance.Y_Pos;
}
...
{
	CST816_DebugFingerNum = CST816_IIC_ReadREG(FingerNum);
	return CST816_DebugFingerNum;
}
