...
/*************************************************************************************************/
/*                      这部分GPIO，SPI，TIM外设由CubMX配置好，或者在其他地方手动初始化              */
/*************************************************************************************************/
...
void st7789_Init(void) {
    ...
    const st7789_command_t initSequence[] = {
        ...
        {ST7789_CMD_MADCTL, 0, 1, ( uint8_t *)"\x00"},      // 页/列地址顺序
 ...
 *
 * 本函数假定 main.c 中已经执行过 MX_GPIO_Init、MX_SPI1_Init 和 MX_TIM3_Init。
